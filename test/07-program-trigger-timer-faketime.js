...
flavors.forEach(function (flavor) {
    ...
    describe('Running ' + __filename.split('/').reverse()[0] + ' [' + flavor + ']', function () {
        ...
        test('2019-03-30 03:04:48 CET',  'Time0305', '1546');
        test('2019-03-30 03:29:48 CET',  'Time0330', '1558');
        test('2019-03-30 23:58:48 CET',  'TimeEveryMinute', '1302', 5, 70000);
        test('2019-03-31 03:04:48 CEST', 'Time0305', '1546');
        test('2019-03-31 03:29:48 CEST', 'Time0330', '1558');
        test('2019-03-31 23:58:48 CEST', 'TimeEveryMinute', '1302', 5, 70000);
        test('2019-04-01 01:59:48 CEST', 'Time0200', '1470');
        test('2019-04-01 02:04:48 CEST', 'Time0205', '1498');
        test('2019-04-01 23:58:48 CEST', 'TimeEveryMinute', '1302', 5, 70000);
