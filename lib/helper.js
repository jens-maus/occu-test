...
function cleanupTest(flavor) {
    describe('cleanup', function () {
        if (procs.rega) {
            step('should still run ReGaHss' + flavor, function (done) {
                this.slow(60000);
                this.timeout(60000);
            ...
            step('should stop ReGaHss' + flavor, function (done) {
                this.slow(60000);
                this.timeout(60000);
        ...
        if (procs.sim) {
            step('should stop rfd/hmipserver simulator', function (done) {
                procs.sim.kill();
                procs.sim = null;
                done();
            });
        ...
        if (rpcClient) {
            step('should disconnect rpc client', function (done) {
